...
build:
    mkdir -p debug
    cd debug && cmake -DCMAKE_EXPORT_COMPILE_COMMANDS=YES -DCMAKE_BUILD_TYPE=Debug -G Ninja -DCMAKE_CXX_FLAGS="-fdiagnostics-absolute-paths -fdiagnostics-color" -DCMAKE_C_FLAGS=-fdiagnostics-color  -DCMAKE_CUDA_ARCHITECTURES=75 -DCMAKE_CUDA_FLAGS=-Wno-deprecated-gpu-targets  ..
