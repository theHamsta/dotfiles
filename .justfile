...
meson-release:
	meson setup --reconfigure --buildtype=release -Dc_flags="-fdiagnostics-absolute-paths -march=native" -Dcpp_flags="-fdiagnostics-absolute-paths -march=native" release
	rm -f compile_commands.json
