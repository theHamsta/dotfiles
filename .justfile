...
release:
    mkdir -p release
    cd release && cmake -DCMAKE_VERBOSE_MAKEFILE=OFF  -DCMAKE_EXPORT_COMPILE_COMMANDS=YES -DCMAKE_CUDA_HOST_COMPILER=g++-9 -DCMAKE_BUILD_TYPE=Release -G Ninja -DCMAKE_CXX_FLAGS="-fdiagnostics-absolute-paths -fdiagnostics-color -march=native" -DCMAKE_C_FLAGS=-fdiagnostics-color -DCMAKE_CUDA_ARCHITECTURES=75 -DCMAKE_CUDA_FLAGS="-Wno-deprecated-gpu-targets -allow-unsupported-compiler" ..
